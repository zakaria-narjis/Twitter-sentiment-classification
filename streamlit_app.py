...
class Streamlitapp:
    ...
    def run(self):
        ...
        st.write('You can start by entering a twitter username, the app will automaticaly analyse all the recents replies on the user\'s recent tweets (7 days max and 100 replies/tweets due to API limitations) and display results through charts.')
